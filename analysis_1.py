...
Usage:
    python analysis_1.py s3://cs439-project-bucket/result/20260225_154602/results.csv
"""
...
def run_shap_analysis(
    ...
    plt.tight_layout()
    plt.savefig(f"shap/shap_phase_1/{output_prefix}_summary.png", dpi=150, bbox_inches="tight")
    plt.close()
    print(f"  Saved: shap/shap_phase_1/{output_prefix}_summary.png")
    ...
    plt.tight_layout()
    plt.savefig(f"shap/shap_phase_1/{output_prefix}_bar.png", dpi=150, bbox_inches="tight")
    plt.close()
    print(f"  Saved: shap/shap_phase_1/{output_prefix}_bar.png")
    ...
    for i, feat in enumerate(FEATURE_COLS):
        ...
        plt.tight_layout()
        fname = f"shap/shap_phase_1/{output_prefix}_dep_{feat}.png"
...
def main() -> None:
    ...
    print(f"\nDone. All plots saved in shap/shap_phase_1 with prefix '{args.output_prefix}_'.")
